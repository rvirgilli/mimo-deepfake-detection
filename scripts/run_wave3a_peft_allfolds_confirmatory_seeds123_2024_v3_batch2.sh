...
RUN_ID="wave3a-peft-allfolds-confirmatory-seeds123-2024-v3-batch2"
START_TS=$(date +%s)
...
RUN_ROOT="experiments/runs/wave3a_xlsr_training_reference_peft_confirmatory_seeds123_2024_v2"
DOC_ROOT="docs/current/wave3a_peft_allfolds_confirmatory_seeds123_2024_v2"
...
root = Path('experiments/runs/wave3a_xlsr_training_reference_peft_confirmatory_seeds123_2024_v2/xlsr_peft_adapter')
...
doc_root = Path('docs/current/wave3a_peft_allfolds_confirmatory_seeds123_2024_v2')
frozen_paths = {
...
summary = {
    'schema': 'mimodf-wave3a-peft-allfolds-confirmatory/v2-batch2',
